...
PERMISSION_SCOPE_GROUPS = [
    ...
    # ── RH ────────────────────────────────────────────────────────────────────
    {
        ...
        'items': [
            ...
            {'name': 'action.diarias.aprovar',       'label': 'Aprovar diárias / hotelaria',         'platforms': ['web'],        'auto_enable': ['menu.diarias'],            'description': 'Permite aprovar ou reprovar pedidos de diárias — geralmente quem atende o financeiro.'},
